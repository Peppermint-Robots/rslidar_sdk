...
struct RsCompressedImage_
{
  ...
  RsCompressedImage_() : header(), type(0), data() {}
  RsCompressedImage_(const ContainerAllocator & _alloc) : header(_alloc), type(0), data(_alloc)
  {
    (void)_alloc;
  }
...
std::ostream & operator<<(
  std::ostream & s, const ::rscamera_msg::RsCompressedImage_<ContainerAllocator> & v)
{
  ros::message_operations::Printer<::rscamera_msg::RsCompressedImage_<ContainerAllocator>>::stream(
    s, "", v);
  return s;
}
...
bool operator==(
  const ::rscamera_msg::RsCompressedImage_<ContainerAllocator1> & lhs,
  const ::rscamera_msg::RsCompressedImage_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header && lhs.type == rhs.type && lhs.data == rhs.data;
}
...
template <class ContainerAllocator>
struct IsMessage<::rscamera_msg::RsCompressedImage_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct IsMessage<::rscamera_msg::RsCompressedImage_<ContainerAllocator> const> : TrueType
{
};

template <class ContainerAllocator>
struct IsFixedSize<::rscamera_msg::RsCompressedImage_<ContainerAllocator>> : FalseType
{
};

template <class ContainerAllocator>
struct IsFixedSize<::rscamera_msg::RsCompressedImage_<ContainerAllocator> const> : FalseType
{
};

template <class ContainerAllocator>
struct HasHeader<::rscamera_msg::RsCompressedImage_<ContainerAllocator>> : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader<::rscamera_msg::RsCompressedImage_<ContainerAllocator> const> : TrueType
{
};
...
{
  static const char * value() { return "4044c7c7aa754eb9dc4031aaf0ca91a7"; }

  static const char * value(const ::rscamera_msg::RsCompressedImage_<ContainerAllocator> &)
  {
    return value();
  }
...
{
  static const char * value() { return "rscamera_msg/RsCompressedImage"; }
...
template <class ContainerAllocator>
struct Serializer<::rscamera_msg::RsCompressedImage_<ContainerAllocator>>
{
...
struct Printer<::rscamera_msg::RsCompressedImage_<ContainerAllocator>>
{
  ...
  static void stream(
    ...
    const ::rscamera_msg::RsCompressedImage_<ContainerAllocator> & v)
  {
    s << indent << "header: ";
    s << std::endl;
