...
struct RslidarPacket_
{
  ...
  RslidarPacket_() : header(), is_difop(0), is_frame_begin(0), data() {}
  RslidarPacket_(const ContainerAllocator & _alloc)
  : header(_alloc), is_difop(0), is_frame_begin(0), data(_alloc)
  {
    (void)_alloc;
  }
  ...
  typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other>
    _data_type;
  _data_type data;
...
std::ostream & operator<<(
  std::ostream & s, const ::rslidar_msg::RslidarPacket_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::rslidar_msg::RslidarPacket_<ContainerAllocator> >::stream(
    s, "", v);
  return s;
}
...
bool operator==(
  const ::rslidar_msg::RslidarPacket_<ContainerAllocator1> & lhs,
  const ::rslidar_msg::RslidarPacket_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header && lhs.is_difop == rhs.is_difop &&
         lhs.is_frame_begin == rhs.is_frame_begin && lhs.data == rhs.data;
}
...
template <class ContainerAllocator>
struct IsMessage< ::rslidar_msg::RslidarPacket_<ContainerAllocator> > : TrueType
{
};

template <class ContainerAllocator>
struct IsMessage< ::rslidar_msg::RslidarPacket_<ContainerAllocator> const> : TrueType
{
};

template <class ContainerAllocator>
struct IsFixedSize< ::rslidar_msg::RslidarPacket_<ContainerAllocator> > : FalseType
{
};

template <class ContainerAllocator>
struct IsFixedSize< ::rslidar_msg::RslidarPacket_<ContainerAllocator> const> : FalseType
{
};

template <class ContainerAllocator>
struct HasHeader< ::rslidar_msg::RslidarPacket_<ContainerAllocator> > : TrueType
{
};

template <class ContainerAllocator>
struct HasHeader< ::rslidar_msg::RslidarPacket_<ContainerAllocator> const> : TrueType
{
};
...
{
  static const char * value() { return "4b1cc155a9097c0cb935a7abf46d6eef"; }

  static const char * value(const ::rslidar_msg::RslidarPacket_<ContainerAllocator> &)
  {
    return value();
  }
...
{
  static const char * value() { return "rslidar_msg/RslidarPacket"; }
...
template <class ContainerAllocator>
struct Serializer< ::rslidar_msg::RslidarPacket_<ContainerAllocator> >
{
...
struct Printer< ::rslidar_msg::RslidarPacket_<ContainerAllocator> >
{
  ...
  static void stream(
    ...
    const ::rslidar_msg::RslidarPacket_<ContainerAllocator> & v)
  {
    s << indent << "header: ";
    s << std::endl;
